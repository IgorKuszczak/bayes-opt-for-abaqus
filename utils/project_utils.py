...
class Simulation:
    ...
    def __init__(self, model_name,script_name,result_metrics, temp_dir, runfile_dir,abaqus_dir = 'abaqus', save_cae = False):
    ...
    def get_results(self, parametrization):       
        ...
        results = {k.decode('utf8'): v for k, v in results.items()}
